...
class Spreadsheet:
    def __init__(self, json_key_file_name, debugMode=False):
        self.debugMode = debugMode
        self.credentials = ServiceAccountCredentials.from_json_keyfile_name(json_key_file_name, ['https://www.googleapis.com/auth/spreadsheets',
    ...
    def prepare_setValues(self, cellsRange, values, majorDimension="ROWS"):
        if self.sheetTitle is None:
            raise SheetNotSetError()
        self.valueRanges.append({"range": self.sheetTitle + "!" + cellsRange,
                                 "majorDimension": majorDimension, "values": values})
...
if __name__ == "__main__":
    ...
    # sheet.share_to_user('aibek.abdykasymov@gmail.com')
